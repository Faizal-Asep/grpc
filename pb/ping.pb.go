...
func (x *Response_Data) GetAccessToken() string {
	if x != nil {
...
func (x *Response_Data) GetRefreshToken() string {
	if x != nil {
...
var file_ping_proto_rawDesc = []byte{
	...
	0x22, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xaf, 0x01, 0x0a, 0x08,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x2e, 0x0a,
	0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x23, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67,
	0x12, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e,
	0x70, 0x62, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x06, 0x5a,
...
var file_ping_proto_goTypes = []interface{}{
	...
	(*Response_Data)(nil), // 2: pb.Response.Data
}
var file_ping_proto_depIdxs = []int32{
	2, // 0: pb.Response.data:type_name -> pb.Response.Data
	0, // 1: pb.Service.Ping:input_type -> pb.Request
	1, // 2: pb.Service.Ping:output_type -> pb.Response
